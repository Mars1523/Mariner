...
public class LeftScoreOnceAlgae extends SequentialCommandGroup {
    final CoralArm coralArm;
    final Elevator elevator;
    final AlgaeArm algaeArm;
    final SwerveSubsystem swerveSubsystem;

    public LeftScoreOnceAlgae(CoralArm coralArm, AlgaeArm algaeArm,
        ...
        addCommands(new AutoDrive(swerveSubsystem, 1, 0.5), GoTo.reefNW(),
