...
public class RightAlignmentSequence extends SequentialCommandGroup {
    ...
    public RightAlignmentSequence(CoralArm coralArm, AlgaeArm algaeArm,
        ...
        var secondConfigureAlign = new AutoAlignReef(swerveSubsystem, NTD.of(0),
                Constants.SetpointConstants.DistanceOffsets.reefCoralConfigure,
                NTD.of(0), NTD.of(0.1), NTD.of(0.1));
        var scoreAlign = new AutoAlignReef(swerveSubsystem,
                Constants.SetpointConstants.StrafeOffsets.rightReef,
                Constants.SetpointConstants.DistanceOffsets.rightReefScore,
        ...
        addCommands(new ParallelCommandGroup(configureAlign, config),
                ...
                new ParallelRaceGroup(secondConfigureAlign, stow));
    }
}
