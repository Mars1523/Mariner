...
public class AlgaeIntakeAlignmentSequence extends SequentialCommandGroup {
    ...
    public AlgaeIntakeAlignmentSequence(CoralArm coralArm, Elevator elevator,
            AlgaeArm algaeArm, SwerveSubsystem swerveSubsystem,
            ConfigOption configOption) {
        var config =
                new ConfigSystem(configOption, coralArm, elevator, algaeArm);
        var stow =
        ...
        var configureAlign = new AutoAlignReef(swerveSubsystem,
                ...
                Constants.SetpointConstants.DistanceOffsets.reefAlgaeConfigure,
                NTD.of(0), NTD.of(0.04), NTD.of(0.04));
        ...
        var intakeAlign = new AutoAlignReef(swerveSubsystem,
                Constants.SetpointConstants.StrafeOffsets.centerReef,
                Constants.SetpointConstants.DistanceOffsets.algaeReefGrab,
                NTD.of(0), NTD.of(0.02), NTD.of(0.02));
        ...
        addCommands(
                ...
                new ParallelRaceGroup(intakeAlign,
                ...
                Commands.print("autodriveback done"), stow,
