...
public class L4AlignmentSequence extends SequentialCommandGroup {
    ...
    public L4AlignmentSequence(CoralArm coralArm, AlgaeArm algaeArm, Elevator elevator, SwerveSubsystem swerveSubsystem,
        ...
        var configureAlign = new AutoAlignReef(swerveSubsystem, strafeOffset,
                Constants.SetpointConstants.DistanceOffsets.reefCoralConfigure, NTD.of(0), NTD.of(0.1), NTD.of(0.07));
