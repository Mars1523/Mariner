...
// public class AutoAlignReefAbs extends Command {
...
//     final Optional<Pose3d> getGoalPose() {
...
//             return Optional.of(targetAbsPose.transformBy(new Transform3d(0,1,0, new Rotation3d())));
...
//     public AutoAlignReefAbs(SwerveSubsystem swerveSub, NTDouble strafeGoal, NTDouble distanceGoal,
