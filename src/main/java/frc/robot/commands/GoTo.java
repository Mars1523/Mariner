...
public class GoTo {
    ...
    public static Command reefN() {
        ...
        return Commands.either(AutoBuilder
                .pathfindToPose(inFrontOfTag(redReefNTagID), constraints)
                .alongWith(Commands.print("going to tag ID" + redReefNTagID)),
                AutoBuilder
                        .pathfindToPose(inFrontOfTag(blueReefNTagID),
                                constraints)
                        .alongWith(Commands
                                .print("going to tag ID" + blueReefNTagID)),
                GoTo::isRed);
    }

    public static Command reefNE() {
        return Commands.either(AutoBuilder
                .pathfindToPose(inFrontOfTag(redReefNETagID), constraints)
                .alongWith(Commands.print("going to tag ID" + redReefNETagID)),
                AutoBuilder
                        .pathfindToPose(inFrontOfTag(blueReefNETagID),
                                constraints)
                        .alongWith(Commands
                                .print("going to tag ID" + blueReefNETagID)),
                GoTo::isRed);
    }

    public static Command reefNW() {
        return Commands.either(AutoBuilder
                .pathfindToPose(inFrontOfTag(redReefNWTagID), constraints)
                .alongWith(Commands.print("going to tag ID" + redReefNWTagID)),
                AutoBuilder
                        .pathfindToPose(inFrontOfTag(blueReefNWTagID),
                                constraints)
                        .alongWith(Commands
                                .print("going to tag ID" + blueReefNWTagID)),
                GoTo::isRed);
    }
    ...
    public static Command reefS() {
        ...
        return Commands.either(AutoBuilder
                .pathfindToPose(inFrontOfTag(redReefSTagID), constraints)
                .alongWith(Commands.print("going to tag ID " + redReefSTagID)),
                AutoBuilder
                        .pathfindToPose(inFrontOfTag(blueReefSTagID),
                                constraints)
                        .alongWith(Commands
                                .print("going to tag ID " + blueReefSTagID)),
                GoTo::isRed);
    }

    public static Command reefSE() {
        return Commands.either(AutoBuilder
                .pathfindToPose(inFrontOfTag(redReefSETagID), constraints)
                .alongWith(Commands.print("going to tag ID " + redReefSETagID)),
                AutoBuilder
                        .pathfindToPose(inFrontOfTag(blueReefSETagID),
                                constraints)
                        .alongWith(Commands
                                .print("going to tag ID " + blueReefSETagID)),
                GoTo::isRed);
    }

    public static Command reefSW() {
        return Commands.either(AutoBuilder
                .pathfindToPose(inFrontOfTag(redReefSWTagID), constraints)
                .alongWith(Commands.print("going to tag ID " + redReefSWTagID)),
                AutoBuilder
                        .pathfindToPose(inFrontOfTag(blueReefSWTagID),
                                constraints)
                        .alongWith(Commands
                                .print("going to tag ID " + blueReefSWTagID)),
                GoTo::isRed);
    }

    public static Command coralStationLeft() {
        return Commands.either(AutoBuilder
                .pathfindToPose(inFrontOfTag(redCsLeftTagID), constraints)
                .alongWith(Commands.print("going to tag ID " + redCsLeftTagID)),
                AutoBuilder
                        .pathfindToPose(inFrontOfTag(blueCsLeftTagID),
                                constraints)
                        .alongWith(Commands
                                .print("going to tag ID " + blueCsLeftTagID)),
                GoTo::isRed);
    }

    public static Command coralStationRight() {
        return Commands.either(AutoBuilder
                .pathfindToPose(inFrontOfTag(redCsRightTagID), constraints)
                .alongWith(
                        Commands.print("going to tag ID " + redCsRightTagID)),
                AutoBuilder
                        .pathfindToPose(inFrontOfTag(blueCsRightTagID),
                                constraints)
                        .alongWith(Commands
                                .print("going to tag ID " + blueCsRightTagID)),
                GoTo::isRed);
    }
