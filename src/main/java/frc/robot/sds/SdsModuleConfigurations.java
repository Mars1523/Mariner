...
public final class SdsModuleConfigurations {
    public static final ModuleConfiguration MK3_STANDARD =
            new ModuleConfiguration(0.1016,
    ...
    public static final ModuleConfiguration MK4N_L2 =
            new ModuleConfiguration(0.10033, 1 / 5.9, true, 1 / 18.75, false);
